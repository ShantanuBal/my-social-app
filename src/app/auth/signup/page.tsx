      ...
      <div className="max-w-md w-full">
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            ...
            <span className="flex-1">Sign up with Facebook</span>
            <span className="text-xs text-gray-600">Coming Soon</span>
          </button>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-black text-gray-400 text-center max-w-xs">
              We are working on adding social login but for now you can create an account using your email and password.
            </span>
          </div>
        </div>
