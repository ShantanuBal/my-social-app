      ...
      <div className="max-w-md w-full">
        ...
        <div className="space-y-3 mb-6">
          <button
            disabled
            title="Coming Soon"
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg bg-gray-900 text-gray-500 cursor-not-allowed opacity-50 relative"
          >
            ...
            <span className="text-xs text-blue-300 bg-blue-900/30 border border-blue-600/40 px-2 py-1 rounded font-medium">Coming Soon</span>
          </button>
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg bg-gray-900 text-gray-500 cursor-not-allowed opacity-50 relative"
          >
            <svg className="w-5 h-5 mr-3 text-blue-500 opacity-50" fill="currentColor" viewBox="0 0 24 24">
