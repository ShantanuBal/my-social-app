...
function SignInForm() {
  ...
  const handleSocialSignIn = async (provider: string) => {
    ...
    try {
      ...
      setError(`Something went wrong with ${provider} sign in`)
      setSocialLoading(null)
    }
  }
      ...
      <div className="max-w-md w-full">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-600 rounded-lg bg-gray-800 hover:bg-gray-700 text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
